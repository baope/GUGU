package com.cwj.gugumall.controller;
...
public class OssController {
    ...
    protected R doGet(HttpServletRequest request, HttpServletResponse response)
            throws ServletException, IOException ,com.aliyuncs.exceptions.ClientException {
        System.out.println("policy");
        // 从环境变量中获取访问凭证。运行本代码示例之前，请确保已设置环境变量OSS_ACCESS_KEY_ID和OSS_ACCESS_KEY_SECRET。
       //   tring host = "https://examplebucket.oss-cn-hangzhou.aliyuncs.com";
        ...
        try {
            ...
            String accessId = OSS_ACCESS_KEY_ID;
            ...
            //String ja1 = JSONObject.toJSONString(respMap);//JSONObject.fromObject(respMap);
